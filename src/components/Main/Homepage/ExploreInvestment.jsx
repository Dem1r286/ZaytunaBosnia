...
const ExploreInvestment = () => {
  const Data = [
    { 
      ...
      urlImage: "./src/assets/realestate.jpg", 
      urlButton: "#",
    ...
    { 
      ...
      urlImage: "./src/assets/agriculture.png", 
      urlButton: "#",
    ...
    { 
      ...
      urlImage: "./src/assets/startup.png", 
      urlButton: "#",
    ...
    { 
      ...
      urlImage: "./src/assets/education.png", 
      urlButton: "#",
  ...
  return (
    <div className="flex flex-col justify-center items-center px-30 bg-gray-100 py-20 rounded-2xl">
          ...
          item.text && ( 
            <div key={idx} className={`flex ${idx % 2 === 0 ? "flex-row" : "flex-row-reverse"} justify-center gap-[10vw] items-center h-[400px]`}>
              ...
              <div className="max-w-2xl text-center">
                ...
                {item.urlButton && (
                  <a href={item.urlButton} className="mt-10 inline-block bg-[#20b970] text-white px-4 py-2 rounded-md hover:bg-[#1a9b61] transition">
                    Learn More
                  </a>
                )}
              </div>
              ...
              {item.urlImage && (
                <div>
                  <img src={item.urlImage} alt="Investment Opportunity" className="w-[700px] rounded-xl shadow-lg" />
                </div>
              )}
            </div>
          )
