...
const DestinationDetails = () => {
  ...
  return (
    <div
      ...
      className="flex justify-center items-center flex-col min-h-screen w-screen py-30 lg:pt-40">
      ...
      <div className="flex justify-between items-center flex-col lg:flex-row w-full px-10 lg:px-30 max-w-[2000px] gap-10 lg:gap-20">
        <div className="flex justify-center items-center flex-col w-full lg:w-[60%]">
          <div className="flex justify-center flex-col items-center bg-gray-100 p-10 rounded-xl">
            {destination?.heading
              ?.split('\n\n')
              .map((paragraph, index) => (
